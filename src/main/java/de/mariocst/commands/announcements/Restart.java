...
public class Restart extends Command {
    public Restart() {
        super("announcerestart", "Schreibt 5mal eine Nachricht, dass der Server restarted wird!", "announcerestart", new String[]{"ars"});
    ...
    public boolean execute(CommandSender sender, String s, String[] args) {
        ...
        if (sender instanceof Player) {
            ...
            if (player.hasPermission("mario.announcerestart") || player.hasPermission("mario.*") || player.hasPermission("*") || player.isOp()) {
